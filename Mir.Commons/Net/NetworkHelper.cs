...
namespace Mir.Commons.Net
{
    ...
    public static class NetworkHelper
    {
        ...
        {
            if (ValidateHelper.IsValidIP(ip))
            {
                return ip;
            }
            else
        ...
        {
            //创建本地终结点
            IPEndPoint localPoint = CreateIPEndPoint(NetworkHelper.LocalHostName, port);
