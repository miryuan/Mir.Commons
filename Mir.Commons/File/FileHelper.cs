...
namespace Mir.Commons.File
{
    ...
    public static class FileHelper
    {
        ...
        public static double GetFileSizeKB(string filePath)
        {
            ...
            //获取文件的大小
            double result = Convert.ToDouble(fi.Length) / 1024;
        ...
        public static double GetFileSizeMB(string filePath)
        {
            ...
            //获取文件的大小
            double result = Convert.ToDouble(fi.Length) / 1024 / 1024;
            return result < 1 ? 1 : result;
        }
        #endregion
        ...
        public static object LoadObjectFromXml(string path, Type type)
        {
            ...
            using (StreamReader reader = new StreamReader(path))
            {
                ...
                obj = XmlHelper.XmlToObject(content, type);
            }
            return obj;
        }
        ...
        {
            string xml = XmlHelper.ObjectToXml(obj, true);
